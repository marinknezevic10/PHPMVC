...
<html lang="en-US">
  <head>
    ...
    <link rel="stylesheet" href="<?=ASSETS?>templates/owl-carousel/owl.carousel.css">
    <link rel="stylesheet" href="<?=ASSETS?>templates/owl-carousel/owl.theme.css">
    <link rel="stylesheet" href="<?=ASSETS?>templates/css/lightcase.css">
    <!-- CUSTOM STYLE -->      
    <link rel="stylesheet" href="<?=ASSETS?>templates/css/template-style.css">
  ...
  <body class="size-1140">
  	...
  	<a target="_blank" class="hide-s" href="../template/minimalista-premium-responsive-business-template/" style="position:fixed;top:120px;right:-14px;z-index:10;"><img src="<?=ASSETS?>templates/img/premium-features.png" alt=""></a>
    <div id="page-wrapper">
      <!-- HEADER -->
        ...
        <nav class="background-transparent background-transparent-hightlight full-width sticky">
          <div class="s-12 l-2">
            <a href="index.html" class="logo">
              ...
              <img class="logo-before" src="<?=ASSETS?>templates/img/logo-dark.png" alt="">
          ...
          <div class="background-white full-width"> 
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-01.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-02.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-03.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-04.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-05.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-06.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-07.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-08.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-09.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-10.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-11.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
                ...
                <img class="full-img" src="<?=ASSETS?>templates/img/portfolio/thumb-12.jpg" alt=""/>
              </a>	
            </div>
            <div class="s-12 m-6 l-five">
              <a class="image-with-hover-overlay image-hover-zoom" href="/" title="Portfolio Image">
    ...
    <script type="text/javascript" src="<?=ASSETS?>templates/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>templates/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>templates/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>templates/js/template-scripts.js"></script> 
  </body>
</html>